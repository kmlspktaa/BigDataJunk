...
"separatorChar" = ",",
"quoteChar" = "\"")   
LOCATION '/user/databases/sqlserver/musicdb/tracks/';
-- TBLPROPERTIES ("skip.header.line.count"="1");
...
"separatorChar" = ",",
"quoteChar" = "\"")  
LOCATION '/user/databases/sqlserver/musicdb/playlist/';
-- TBLPROPERTIES ("skip.header.line.count"="1");
...
"separatorChar" = ",",
"quoteChar" = "\"")  
LOCATION '/user/databases/sqlserver/musicdb/playlisttrack/';
-- TBLPROPERTIES ("skip.header.line.count"="1");
...
"separatorChar" = ",",
"quoteChar" = "\"")  
LOCATION '/user/databases/mysql/musicdb/albums/';
-- TBLPROPERTIES ("skip.header.line.count"="1");
...
"separatorChar" = ",",
"quoteChar" = "\"")  
LOCATION '/user/databases/mysql/musicdb/artist/';
-- TBLPROPERTIES ("skip.header.line.count"="1");
...
"separatorChar" = ",",
"quoteChar" = "\"")  
LOCATION '/user/databases/mysql/musicdb/edges/';
-- TBLPROPERTIES ("skip.header.line.count"="1");
...
"separatorChar" = ",",
"quoteChar" = "\"")  
LOCATION '/user/databases/csv/opensource';
-- TBLPROPERTIES ("skip.header.line.count"="1");
