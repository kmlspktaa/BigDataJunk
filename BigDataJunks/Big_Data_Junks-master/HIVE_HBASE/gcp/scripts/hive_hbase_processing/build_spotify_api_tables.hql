...
CREATE TABLE asl.track_details(row_id int, id int, artist_name VARCHAR(1000), track_name VARCHAR(2500), track_id VARCHAR(1000), popularity int, year_ int)
ROW FORMAT DELIMITED
FIELDS TERMINATED BY ',';
...
CREATE TABLE asl.2020_songs(row_id int, id int, artist_name VARCHAR(1000), track_name VARCHAR(2500), track_id VARCHAR(1000), popularity int, year_ int)
ROW FORMAT DELIMITED
FIELDS TERMINATED BY ',';
